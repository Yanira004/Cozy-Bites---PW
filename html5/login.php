...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($captchaUtilizator !== $_SESSION['captcha_rezultat']) {
        $mesajEroare = "Captcha incorect! Mai încearcă.";
    } else {
...
$nr1 = rand(1, 9);
$nr2 = rand(1, 9);
$_SESSION['captcha_rezultat'] = $nr1 + $nr2;
?>
    ...
    <form>
        <fieldset style="text-align: center; padding: 40px; background-color: #FFF9F0;">
            ...
            <p style="color: #4A3320; font-size: 18px; margin-bottom: 25px;">
                Rolul tău actual pe platformă este: <b style="color: #D2691E;"><?php echo htmlspecialchars($_SESSION['rol']); ?></b>
            </p>
...
<?php else: ?>
    ...
    <form id="loginForm" action="login.php" method="POST">
        <fieldset>
            ...
            <p>
                <label>Dovedește că ești om: </label><br>
                <strong>Cât fac <?php echo $nr1; ?> + <?php echo $nr2; ?>?</strong>
                <input type="number" name="captcha_raspuns" placeholder="Rezultatul" required
            ...
            <p class="link-inregistrare">
                Nu ai cont încă? <a href="auth.html">Creează unul aici</a>.
            </p>
        </fieldset>
    </form>
